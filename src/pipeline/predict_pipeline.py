...
class PredictionPipeline:
    def __init__(self, request: request):
        self.request = request  # This is the correct reference
        ...
        self.preprocessor = self.utils.load_object(file_path=self.prediction_pipeline_config.preprocessor_path)
